...
DROP TABLE IF EXISTS teams_player CASCADE;
DROP TABLE IF EXISTS venues CASCADE;
DROP TABLE IF EXISTS event_categories CASCADE;
DROP TABLE IF EXISTS competition_types CASCADE;
DROP TABLE IF EXISTS event_types CASCADE;
DROP TABLE IF EXISTS events CASCADE;
DROP TABLE IF EXISTS event_player CASCADE;
...
CREATE TABLE IF NOT EXISTS event_types (
    ...
    CONSTRAINT _et_country_id FOREIGN KEY (event_category) REFERENCES event_categories(id),
    CONSTRAINT _et_competition_type_id FOREIGN KEY (competition_type) REFERENCES competition_types(id)
    );
...
CREATE TABLE IF NOT EXISTS event_player (
      ...
      event TEXT,
      player TEXT,
      CONSTRAINT _ep_player_id FOREIGN KEY (player) REFERENCES players(id),
    CONSTRAINT _ep_event_id FOREIGN KEY (event) REFERENCES events(id)
    );
...
CREATE TABLE IF NOT EXISTS scores (
    ...
    score VARCHAR(255),
    scored_at TIMESTAMP,
    CONSTRAINT _s_event_id FOREIGN KEY (event) REFERENCES events(id),
    CONSTRAINT _s_player_id FOREIGN KEY (player) REFERENCES players(id),
    CONSTRAINT _s_team_id FOREIGN KEY (team) REFERENCES teams(id)
);
...
CREATE TABLE IF NOT EXISTS livestreams (
    ...
    price INTEGER,
    CONSTRAINT _ls_event_id FOREIGN KEY (event) REFERENCES events(id)
);
...
CREATE TABLE IF NOT EXISTS event_teams (
    ...
    team TEXT,
    event TEXT,
    CONSTRAINT _et_event_id FOREIGN KEY (event) REFERENCES events(id),
    CONSTRAINT _et_team_id FOREIGN KEY (team) REFERENCES teams(id)
);